...
export const getInitialUserList = createAsyncThunk(
    ...
    (args, thunkAPI) => {
        ...
        onSnapshot(collection(db, "networknest"), (snapShot) => {
...
export const createUserThunk = createAsyncThunk(
    ...
    async (data, thunkAPI) => {
        ...
        // Add a new document to the 'networknest' collection in the database
        const docRef = await addDoc(collection(db, "networknest"), {
            name: data.name,
            email: data.email,
